...
Chúng ta thấy rằng **self.apr** thì cho phép override, còn **self.__class__.apr** thì luôn lấy giá trị apr của class đó, dù gán thêm bên ngoài thì giá trị này cũng không đổi. Nếu chúng ta muốn an toàn luôn sử dụng giá trị apr được khai báo trong class thì nên dùng **self.__class__.apr**.
