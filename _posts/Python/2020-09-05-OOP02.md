...
![](/assets/piks/Python/OOP02_scope1.PNG)
...
![](/assets/piks/Python/OOP02_scope2.PNG)
...
Phần giới thiệu sâu thêm về class và object đến đây là hết. [Phần 03](https://votatdat.github.io/2020-09-05-OOP03) sẽ giới thiệu về Polymorphism (đa hình) và các method đặc biệt.